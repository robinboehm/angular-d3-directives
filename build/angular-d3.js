...
angular.module('d3').factory('d3', [function () {
    var d3 = function () {
        ...
        function L(t, n) {
          var e;
          return 2 > arguments.length && (n = 0.45), arguments.length ? e = n / (2 * Ti) * Math.asin(1 / t) : (t = 1, e = n / 4), function (r) {
        ...
        function O(t) {
          var n = [
              ...
              t.c,
              t.d
            ], r = U(n), u = Y(n, e), i = U(I(e, n, -u)) || 0;
          n[0] * e[1] < e[0] * n[1] && (n[0] *= -1, n[1] *= -1, r *= -1, u *= -1), this.rotate = (r ? Math.atan2(n[1], n[0]) : Math.atan2(-e[0], e[1])) * Di, this.translate = [
            t.e,
            t.f
          ], this.scale = [
            r,
        ...
        function W(t, n, e) {
          ...
          return o ? (u = 0.5 > c ? o / (a + i) : o / (2 - a - i), r = t == a ? (n - e) / o + (e > n ? 6 : 0) : n == a ? (e - t) / o + 2 : (t - n) / o + 4, r *= 60) : u = r = 0, en(r, u, c);
        }
        function Q(t, n, e) {
          t = tn(t), n = tn(n), e = tn(e);
          var r = pn((0.4124564 * t + 0.3575761 * n + 0.1804375 * e) / sa), u = pn((0.2126729 * t + 0.7151522 * n + 0.072175 * e) / ha), i = pn((0.0193339 * t + 0.119192 * n + 0.9503041 * e) / ga);
        ...
        function un(t, n, e) {
          ...
          var i, a;
          return t %= 360, 0 > t && (t += 360), n = 0 > n ? 0 : n > 1 ? 1 : n, e = 0 > e ? 0 : e > 1 ? 1 : e, a = 0.5 >= e ? e * (1 + n) : e + n - e * n, i = 2 * e - a, $(u(t + 120), u(t), u(t - 120));
        }
        function an(t, n, e) {
          return new on(t, n, e);
        }
        ...
        function sn(t, n, e) {
          ...
          return u = gn(u) * sa, r = gn(r) * ha, i = gn(i) * ga, $(dn(3.2404542 * u - 1.5371385 * r - 0.4985314 * i), dn(-0.969266 * u + 1.8760108 * r + 0.041556 * i), dn(0.0556434 * u - 0.2040259 * r + 1.0572252 * i));
        }
        function hn(t, n, e) {
        ...
        function jn(t, n) {
          ...
          if (e.createSVGPoint) {
            ...
            return Da ? (r.x = n.pageX, r.y = n.pageY) : (r.x = n.clientX, r.y = n.clientY), r = r.matrixTransform(t.getScreenCTM().inverse()), [
              r.x,
              r.y
            ];
          }
        ...
        function Kn(t, n) {
          ...
          return e.invert = function (n) {
            ...
            if (2 > arguments.length && (u = La), !arguments.length)
              return u;
            var i, a = Math.max(0.1, t / e.ticks().length), o = n === Qn ? (i = -1e-12, Math.floor) : (i = 1e-12, Math.ceil);
            return function (t) {
        ...
        function ue(t, n, e) {
          ...
          return r.domain = function (e) {
            return arguments.length ? (t = +e[0], n = +e[e.length - 1], u()) : [
              t,
              n
            ];
          }, r.range = function (t) {
        ...
        function se(t) {
          function n(n) {
            ...
            for (var o, f = [], s = [], h = -1, g = n.length, p = c(e), d = c(r); g > ++h;)
              u.call(this, o = n[h], h) ? s.push([
                +p.call(this, o, h),
                +d.call(this, o, h)
              ]) : s.length && (a(), s = []);
            return s.length && a(), f.length ? f.join('') : null;
          }
          var e = he, r = ge, u = o, i = pe, a = i.key, l = 0.7;
        ...
        function me(t) {
          for (var n = 0, e = t.length, r = t[0], u = [
                r[0],
                ',',
                r[1]
              ]; e > ++n;)
        ...
        function we(t) {
          if (3 > t.length)
            return pe(t);
          var n = 1, e = t.length, r = t[0], u = r[0], i = r[1], a = [
              u,
              u,
              u,
              (r = t[1])[0]
        ...
        function Ce(t) {
          for (var n, e, r, u, i = [], a = qe(t), o = -1, c = t.length - 1; c > ++o;)
            n = Te(t[o], t[o + 1]), 0.000001 > Math.abs(n) ? a[o] = a[o + 1] = 0 : (e = a[o] / n, r = a[o + 1] / n, u = e * e + r * r, u > 9 && (u = 3 * n / Math.sqrt(u), a[o] = u * e, a[o + 1] = u * r));
          for (o = -1; c >= ++o;)
            u = (t[Math.min(c, o + 1)][0] - t[Math.max(0, o - 1)][0]) / (6 * (1 + a[o] * a[o])), i.push([
              u || 0,
              a[o] * u || 0
            ]);
          return i;
        ...
        function Le(t) {
          ...
          var e = he, r = he, u = 0, i = ge, a = o, l = pe, f = l.key, s = l, h = 'L', g = 0.7;
          return n.x = function (t) {
        ...
        function _r(t, n, e) {
          ...
          if (r && (u || i)) {
            ...
            a *= a, r *= r;
            var c = 0.5 + (r - a) / (2 * o), l = Math.sqrt(Math.max(0, 2 * a * (r + o) - (r -= o) * r - a * a)) / (2 * o);
        ...
        function Wr(t) {
          ...
          function e(n, u, i, a, o, c, l, f, s, h, g, p, d, m) {
            ...
            if (M > 4 * r && d--) {
              ...
              (C * C / M > r || Math.abs((v * T + y * q) / M - 0.5) > 0.3) && (e(n, u, i, a, o, c, A, N, k, b /= w, x /= w, _, d, m), m.point(A, N), e(A, N, k, b, x, _, l, f, s, h, g, p, d, m));
            }
          }
          var r = 0.5, u = 16;
        ...
        function vu(t) {
          ...
          function r(t, n) {
            var e = Xr(t, 0), r = Xr(n, 0), u = [
                1,
                0,
                0
              ], a = $r(e, r), o = Br(a, a), c = a[0], l = o - c * c;
            if (!l)
              return t;
        ...
        function Su(t, n) {
          return [
            t / (2 * Ti),
            Math.max(-0.5, Math.min(0.5, Math.log(Math.tan(Ti / 4 + n / 2)) / (2 * Ti)))
          ];
        }
        function ku(t) {
        ...
        function Hu(t) {
          ...
          function e(t) {
            return t = a.invert((t[0] - o) / f, (c - t[1]) / f), t && [
              t[0] * Di,
              t[1] * Di
            ];
          }
          ...
          return n.stream = function (t) {
            ...
            return arguments.length ? (s = +t[0], h = +t[1], r()) : [
              s,
              h
            ];
          }, n.center = function (t) {
            return arguments.length ? (g = t[0] % 360 * zi, p = t[1] % 360 * zi, r()) : [
              g * Di,
              p * Di
            ];
          }, n.rotate = function (t) {
            return arguments.length ? (d = t[0] % 360 * zi, m = t[1] % 360 * zi, v = t.length > 2 ? t[2] % 360 * zi : 0, r()) : [
              d * Di,
              m * Di,
              v * Di
            ];
        ...
        function Xu(t, n) {
          var e = {
              ...
              bisect: function (t, n) {
                ...
                return e.c = t.x * r + t.y * u + 0.5 * (r * r + u * u), i > a ? (e.a = 1, e.b = u / r, e.c /= r) : (e.b = 1, e.a = r / u, e.c /= u), e;
              },
        ...
        function $u(t, n, e, r, u, i) {
          if (!t(n, e, r, u, i)) {
            var a = 0.5 * (e + u), o = 0.5 * (r + i), c = n.nodes;
        ...
        var Ti = Math.PI, qi = 0.000001, Ci = { version: '3.0.8' }, zi = Ti / 180, Di = 180 / Ti, Li = document, Fi = window, Hi = '.', ji = ',', Pi = [
            3,
            3
          ];
        ...
        var fa = 18, sa = 0.95047, ha = 1, ga = 1.08883, pa = fn.prototype = new B();
        ...
        Ci.svg.line.radial = function () {
          ...
          function e(t, n) {
            var e = r.call(this, t, n), a = u.call(this, t, n), o = (e.y + a.y) / 2, c = [
                e,
                {
                  x: e.x,
                  y: o
        ...
        Ci.svg.axis = function () {
          function t(t) {
            t.each(function () {
              var t, s = Ci.select(this), h = null == l ? e.ticks ? e.ticks.apply(e, c) : e.domain() : l, g = null == n ? e.tickFormat ? e.tickFormat.apply(e, c) : String : n, p = Ie(e, h, f), d = s.selectAll('.tick.minor').data(p, String), m = d.enter().insert('line', '.tick').attr('class', 'tick minor').style('opacity', 0.000001), v = Ci.transition(d.exit()).style('opacity', 0.000001).remove(), y = Ci.transition(d).style('opacity', 1), M = s.selectAll('.tick.major').data(h, String), b = M.enter().insert('g', 'path').attr('class', 'tick major').style('opacity', 0.000001), x = Ci.transition(M.exit()).style('opacity', 0.000001).remove(), _ = Ci.transition(M).style('opacity', 1), w = On(e), S = s.selectAll('.domain').data([0]), k = (S.enter().append('path').attr('class', 'domain'), Ci.transition(S)), E = e.copy(), A = this.__chart__ || E;
        ...
        Ci.svg.brush = function () {
          ...
          function u() {
            ...
            function h() {
              var t = u(), i = !1;
              m && (t[0] += m[0], t[1] += m[1]), S || (Ci.event.altKey ? (d || (d = [
                (f[0][0] + f[1][0]) / 2,
                (f[0][1] + f[1][1]) / 2
              ]), k[0] = f[+(t[0] < d[0])][0], k[1] = f[+(t[1] < d[1])][1]) : d = null), _ && g(t, o, 0) && (e(b), i = !0), w && g(t, c, 1) && (r(b), i = !0), i && (n(b), M({
                type: 'brush',
                mode: S ? 'move' : 'resize'
              }));
            }
          ...
          var i, a = R(t, 'brushstart', 'brush', 'brushend'), o = null, c = null, l = Ka[0], f = [
              [
                0,
                0
              ],
        ...
        Ci.behavior = {}, Ci.behavior.drag = function () {
          ...
          function n() {
            ...
            r ? (a = r.apply(o, arguments), a = [
              a.x - s[0],
              a.y - s[1]
            ]) : a = [
              0,
              0
            ], null == f && j(), c({ type: 'dragstart' });
          }
          ...
          return t.translate = function (n) {
            ...
            return arguments.length ? (m = n, d = n.copy(), b = [
              0,
              0
            ], x = 1, t) : m;
          }, t.y = function (n) {
            return arguments.length ? (y = n, v = n.copy(), b = [
              0,
              0
            ], x = 1, t) : y;
          }, Ci.rebind(t, w, 'on');
        ...
        Ci.layout = {}, Ci.layout.bundle = function () {
          ...
          var e, r, u, i, o, c = {}, l = Ci.dispatch('start', 'tick', 'end'), f = [
              1,
              1
            ], s = 0.9, h = no, g = eo, p = -30, d = 0.1, m = 0.8, v = [], y = [];
        ...
        Ci.layout.histogram = function () {
          ...
          var n = Ci.layout.hierarchy().sort(pr), e = 0, r = [
              1,
              1
            ];
          ...
          var n = Ci.layout.hierarchy().sort(null).value(null), e = Ar, r = [
              1,
              1
            ];
          ...
          var a, o = Ci.layout.hierarchy(), c = Math.round, l = [
              1,
              1
            ], f = null, s = Pr, h = !1, g = 'squarify', p = 0.5 * (1 + Math.sqrt(5));
          return i.size = function (t) {
            return arguments.length ? (l = t, i) : l;
          }, i.padding = function (t) {
            function n(n) {
              var e = t.call(i, n, n.depth);
              return null == e ? Pr(n) : Rr(n, 'number' == typeof e ? [
                e,
                e,
                e,
                e
            ...
            if (!arguments.length)
              return f;
            var r;
            return s = null == (f = t) ? Pr : 'function' == (r = typeof t) ? n : 'number' === r ? (t = [
              t,
              t,
              t,
              t
        ...
        Ci.geo.albersUsa = function () {
          ...
          var e = Ci.geo.albers(), r = Ci.geo.albers().rotate([
              160,
              0
            ]).center([
              0,
          ...
          return t.scale = function (n) {
            return arguments.length ? (e.scale(n), r.scale(0.6 * n), u.scale(n), i.scale(1.5 * n), t.translate(e.translate())) : e.scale();
          }, t.translate = function (n) {
            if (!arguments.length)
              return e.translate();
            var a = e.scale(), o = n[0], c = n[1];
            return e.translate(n), r.translate([
              o - 0.4 * a,
              c + 0.17 * a
            ]), u.translate([
              o - 0.19 * a,
          ...
          return r.parallels = function (r) {
            return arguments.length ? e(t = r[0] * zi, n = r[1] * zi) : [
              t * Di,
              n * Di
            ];
          }, r.rotate([
        ...
        (Ci.geo.gnomonic = function () {
          ...
          return t.lines = function () {
            ...
            return arguments.length ? (c = +n[0], l = +n[1], t) : [
              c,
              l
            ];
        ...
        (Ci.geo.orthographic = function () {
          ...
          return t.area = function (t) {
            ...
            return fo = ho = go = po = 0, Ci.geo.stream(t, r(wo)), po ? [
              ho / po,
              go / po
            ] : void 0;
          }, t.bounds = function (t) {
        ...
        Ci.geom.delaunay = function (t) {
          ...
          function i(t, n, e, r, u, i) {
            if (!isNaN(n.x) && !isNaN(n.y))
              if (t.leaf) {
                var o = t.point;
                o ? 0.01 > Math.abs(o.x - n.x) + Math.abs(o.y - n.y) ? a(t, n, e, r, u, i) : (t.point = null, a(t, o, e, r, u, i), a(t, n, e, r, u, i)) : t.point = n;
              } else
                a(t, n, e, r, u, i);
          }
          function a(t, n, e, r, u, a) {
            var o = 0.5 * (e + u), c = 0.5 * (r + a), l = n.x >= o, f = n.y >= c, s = (f << 1) + l;
        ...
        var zo = Date.prototype, Do = '%a %b %e %X %Y', Lo = '%m/%d/%Y', Fo = '%H:%M:%S', Ho = [
            'Sunday',
            'Monday',
            'Tuesday',
            'Wednesday',
        ...
        var Oo = Ku(Ho), Yo = Ku(jo), Uo = Ku(Po), Io = Wu(Po), Vo = Ku(Ro), Zo = Wu(Ro), Xo = {
            ...
            Y: function (t, n) {
              return Qu(t.getFullYear() % 10000, n, 4);
            },
            Z: vi,
            '%': function () {
              return '%';
        ...
        Ci.time.format.iso = Date.prototype.toISOString && +new Date('2000-01-01T00:00:00.000Z') ? yi : Ko, yi.parse = function (t) {
          ...
          return new qo(1000 * Math.floor(t / 1000));
        }, function (t, n) {
          t.setTime(t.getTime() + 1000 * Math.floor(n));
        }, function (t) {
          return t.getSeconds();
        }), Ci.time.seconds = Ci.time.second.range, Ci.time.seconds.utc = Ci.time.second.utc.range, Ci.time.minute = Mi(function (t) {
          return new qo(60000 * Math.floor(t / 60000));
        }, function (t, n) {
          t.setTime(t.getTime() + 60000 * Math.floor(n));
        }, function (t) {
          return t.getMinutes();
          ...
          return new qo(3600000 * (Math.floor(t / 3600000 - n) + n));
        }, function (t, n) {
          t.setTime(t.getTime() + 3600000 * Math.floor(n));
        }, function (t) {
          return t.getHours();
          ...
          return Math.floor((t - n - 60000 * (t.getTimezoneOffset() - n.getTimezoneOffset())) / 86400000);
...
'use strict';
angular.module('d3').config(function ($provide) {
      ...
      link: function postLink(scope, element, attrs) {
        ...
        var cloudFactory = function (words) {
          ...
          d3.layout.cloud().size([
            ...
            return {
              text: d,
              size: fontSize + Math.random() * fontSize * 10
            };
          })).rotate(function () {
